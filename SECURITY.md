...
Algorithm Builder App is pre-alpha. There are no production-supported versions yet. Security fixes target the current main branch unless a maintainer explicitly publishes another supported line.

## Scope

Security-sensitive areas include algorithm construction, Docker services, classroom examples, and supervised gateway handoff. Reports should focus on real behavior in this repository or on its documented gateway boundary.
