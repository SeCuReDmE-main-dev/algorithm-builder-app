...
Project-specific focus: Strict separation of Express/server responsibilities from React/client code, safe algorithm construction, input validation, and deterministic educational behavior.
